  ...
  return (
    <>
      ...
      <div className="page row" ref={contentRef}>
        <div>
          <Text styleClass="text1">무한도전은
            <br /> 문화생활을 함께 해줄 동반자 서비스 입니다
          </Text>
          <Text styleClass="text2">다양한 공연 정보 탐색부터
      ...
      <div className="page row" id="gray">
        <div>
          ...
          <Text styleClass="text2">티켓팅 연습을 위해 좌석 위치를 확인하고, 
      ...
      <div className="page column">
        <div>
          ...
          <Text styleClass="text1">다양한 공연 정보를
            <br />둘러볼 수 있어요.
          </Text>
          <Text styleClass="text2">뮤지컬, 연극, 콘서트 등 다양한 공연 정보를 확인 할 수 있어요.
      ...
      <div className="page column">
        <div>
          ...
          <Text styleClass="text2">지금껏 도전한 티켓팅 시도 횟수를 알아보고, 성공한 횟수를 한눈에 볼 수 있어요.
      ...
      <div className="page column">
        <div>
          ...
          <Text styleClass="text1">무한도전 서비스를 기획하고,
            <br />제작한 사람들을 알아볼까요?
          </Text>
        </div>
